...
//output ==> there was an uncaught error: Error: ENOENT: no such file or directory, open '**\NodeJs\File System\files\module.txt'

//using PATH lib instead of hard coding the path (already imported on top)
// fs.readFile(
//   path.join(__dirname, "files", "starter.txt"), //_dirname = terminal User folder path where your server.js file is located.(i.e: "{dir}/NODEJS/FileSystem/***")
//   "utf8",
//   (err, data) => {
//     if (err) throw err;
